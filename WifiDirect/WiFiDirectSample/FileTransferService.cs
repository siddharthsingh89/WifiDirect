...
namespace com.example.android.wifidirect
{
    ...
    {
        private const int SocketTimeout = 60000;
        ...
        {
            base.OnCreate();
            Log.Debug("Sid", "intent service created!");
        }
        ...
        {
            base.OnDestroy();
            Log.Debug("Sid", "intent service destroyed!");
        ...
        protected override void OnHandleIntent(Intent intent)
        {
            ...
            if (intent.Action.Equals(ActionSendFile))
            {
                ...
                Log.Debug(WiFiDirectActivity.Tag, "file selected is " + fileUri);
